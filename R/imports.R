...
#' @importFrom stats AIC BIC as.formula coef df.residual formula median nls nls.control residuals sd setNames vcov qt predict fitted qnorm logLik nobs uniroot
