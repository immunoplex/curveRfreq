# \\\partial x / \partial y\\ for the loglogistic5 Inverse with Fixed \\a\\

\\\partial x / \partial y\\ for the loglogistic5 Inverse with Fixed
\\a\\

## Usage

``` r
grad_y_loglogistic5_fixed(y, fixed_a, b, d, g)
```
